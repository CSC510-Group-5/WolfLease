...
|Number of commits|3|[59](https://github.com/subodh30/WolfLease/compare/master...CSC510-Group-5:WolfLease:master)|
...
|Docs: what: point descriptions of each class/function (in isolation)|3|[For example](https://gentle-smoke-0777e400f.2.azurestaticapps.net/models.html)|
...
|Do you have tests that can be run after your software has been built or deployed to show whether the build or deployment has been successful?|0|No|
...
|Are all manually-run tests documented?|0|There are no manual tests|
